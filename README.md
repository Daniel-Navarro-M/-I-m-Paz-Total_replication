...
Title: for the non-spanish speaking curious ones, the title is a
wordplay with the Policy Name \"Paz Total\" and the word \"Impás\" which
translates to stalemate, which makes it sound like: Total Stalemate.

# Introduction

Violence in Colombia remains geographically uneven, organizationally
fragmented, and historically persistent. Although the 2016 peace
agreement with the FARC-EP marked a turning point in the country's
recent history, it did not produce a uniform transition to peace across
the national territory. As Johnson et al. note, the agreement "marked a
milestone in the country's recent history" because it demobilized the
most important armed group that represented the greatest threat to state
control," allowing "multiple regions of the country to experience peace
after decades of absence" (Johnson et al., 2025, p. 7, author's
translation). Yet they also stress that, after the demobilization of the
FARC, "some regions repeated cycles of violence" as other armed and
criminal groups expanded their zones of control and dissident FARC
factions emerged (Johnson et al., 2025, p. 7, author's translation).

In this sense, the post-2016 period should be understood less as a
linear transition from war to peace than as a reconfiguration of armed
order across territories with different institutional, political, and
criminal structures. This interpretation is consistent with Pécaut's
long-run reading of the Colombian conflict, which emphasizes the
exceptional continuity of armed organization and notes that the FARC
maintained both "longevity" and "cohesion" even as Colombia underwent
profound social and political transformations (Pécaut, 2008, pp. 23-24).

The persistence of violence is also evident in the broader national
security context. Grasa observes that, six years after the 2016
agreement, the International Committee of the Red Cross still recognized
six non-international armed conflicts in Colombia, including
confrontations between the state and irregular actors as well as
conflicts among illegal armed organizations themselves (Grasa, 2022,
p. 4, author's translation). The diversity of violence in Colombia is
therefore not reducible to one actor, one war, or one mechanism of
coercion. It includes insurgent conflict, criminal governance,
extortion, targeted killings, territorial disputes, forced displacement,
confinement, child recruitment, and persistent violence against
civilians and community leaders.

In the classic formulation of Nuestra guerra sin nombre, the Colombian
conflict resists simple dichotomies, since it is simultaneously more
local and more global, and cannot be reduced to rigid categories such as
political versus criminal violence (Gutiérrez Sanín and Sánchez Gómez,
2006, pp. 8-10). More recent work by Valencia and Serrano reaches a
similar conclusion: the current cycle of violence is marked by
fragmentation, subnationalization, and the increasing importance of
localized interactions among armed actors rather than a single national
logic of war (Valencia and Serrano, 2025, pp. 141-145).

In this context Petro's government inherited a country marked by rising
...
level (FIP, 2023, p. 5, author's translation). Colombia's current
violent landscape is thus not only severe, but also regionally
differentiated and shaped by multiple armed actors whose logics of
control vary across territory. It was in this context that the
government of Gustavo Petro adopted the Política de Paz Total (PPT).

The policy sought to negotiate simultaneously with a broad range of
actors, including insurgent organizations and criminal groups, under an
ambitious and territorially expansive peace agenda. The most thorough
research initiative has been done by Johnson et al. (2025) from the
SOCACE (Serious Organised Crime & Anti-corruption Evidence Research
...
(Valencia and Serrano, 2025, pp. 42-43). The ambition of Paz Total is
therefore precisely what makes it both politically important and
analytically difficult: it seeks to transform violent order across
territories where armed governance takes very different forms. And
hence, Paz Total requires "an integral and multi-actor approach," one
that combines the reduction of direct violence through negotiated
agreements with broader peacebuilding efforts aimed at structural causes
of violence (Grasa, 2022, p. 1, author's translation).
...
Some of the most throughout work comes from InSight Crime, that has an
entire series focusing on the milestones of the policy from a
journalistic position (see Insight Crime, Series Especiales:
Dificultades y Desafíos de la Paz Total en Colombia
...
FIP, 206) which seems to be aligned with recent declarations from
Gustavo Petro who also admitted a policy failure (Swissinfo, 2026).
Overall, the panorama does not seem great. However, the assessments are
merely qualitative or use only descriptive statistics. They assess the
impact from interviews and people's perspectives, or just describe the
latest trends compared in a year to year basis, that does not allow a
further comprehension of the real impact of the policy.

This thesis henceforth begins from a comparative perspective from the
results of Johnson's et. al. (2025), and uses the same units of analysis
in pursue of an added quantitative approach to either reject or support
their conclusions. For this reason, the document focuses on three
territories: Buenaventura, Arauca, and Tumaco. Buenaventura, Colombia's
main Pacific port, is an urban setting marked by criminal governance,
extortion, and territorial rivalry between Los Shottas and Los
Espartanos. Arauca, an eastern border department, has a long history of
insurgent organization, particularly through the ELN's Frente Domingo
...
shifted from homicides and shootings to forced disappearance.

In the same article, it is exposed that the killing of one of the gang
leaders son's starts a clash from both gangs, which pushes an increase
in the homicides during 2023 even with active negotiations. This hence,
will affect the final model and the trends that are inserted into the
two way fixed effect, and for which the control for clash is inserted.
Buenaventura then represents the Urban Armed Groups. It is a very
particular case, as not only it is the main port of the country, but it
is a city greatly impacted by poverty and inequality (Valencia, 2016).
The nature of Buenaventura conflict is very different from other places.
Gangs fight for urban control, gather money from extorting and the sale
of cocaine that is smuggled into the port or is sent to the north in
semi-submersibles. In this sense, gangs are established as control
entities inside the neighborhoods, but their control mechanisms are
limited to these specific areas. They are concentrated in the city, and
the types of violence are more direct towards civilian population:
homicides, extortion, civilian targeting, terrorism and even curfews
(Sánchez-Garzoli, 2024)
...
inquiring in heavy violence. Although the clashes are permanent, the
violent trends in the region are downgrading. Likely due to conflict
stagnation and peace initiatives that are proliferating.
...
with active negotiations, the incursion of other groups into the are
pushing up the general observations of violent crimes. ELN has presence
on several departments, but their horizontal structure keeps them
relatively separated from their counterparts in other regions (Aguilera,
2006). In Arauca ELN relies mostly on coca production, immigrant
smuggling and oil. The groups has shown great interest in continuing a
peace process, but internal fights, and clashes with other groups are
giving varied results. It is not clear if the peace negotiations are
reducing the violence in the region.
...
Having territorial-case and month fixed effects allows to have a more
heterogeneous perspective, and to obtain coefficients that explain a
broad range of armed governance and war related violence. The model
makes each case compare against itself over time while absorbing shocks
common to all cases in a given month. The estimate of the effects of Paz
Total will help assess whether peace talks are associated with shifts in
violence in three theoretically contrasting territories. The scope of
the thesis is deliberately limited. It does not evaluate the entire
national policy, nor does it attempt to explain every armed process
opened under Paz Total. But it reveals a more complex mechanisms that
are contributing to the impacts of the policy.

Furthermore, there are some important limitations to this research.
First, the analysis cannot capture all forms of coercion equally well
due to data constrains. Practices such as forced disappearance, forced
recruitment, massacres, and many forms of displacement fall out of
scope. This matters because these practices remain central to the
contemporary Colombian war. Valencia and Serrano explicitly identify
"child recruitment, confinements, and extortion" as part of the less
visible effects of current violence (Valencia and Serrano, 2025,
p. 143).
...
The remainder of the thesis proceeds as follows. Case selection will
analyze the local implications and specificities of the chosen regions.
The theoretical framework will argue that violence should be understood
as an instrument of territorial control and governance and that the
effects of peace talks depend on timing, sequencing, and local armed
order. The research design, data, and empirical strategy, explaining the
panel structure, treatment coding, and the logic of the two-way
fixed-effects models. The following section will contain the exploratory
data analysis and the main statistical results, with descriptive
evidence that shows how Buenaventura and Tumaco experience declines in
average violence during treatment months, whereas Arauca shows an
increase. And finally the regression results.
...
In that framework, violence is not limited to battlefield confrontation.
It also includes coercive practices aimed at enforcing rules, punishing
disobedience, and shaping local order. This logic is consistent with
Arjona's argument that "when armed groups control a territory and pursue
long-term goals, they prefer to create rebelocracies. If they encounter
a community that is likely to resist collectively, however, they are
likely to limit their rule, establishing aliocracy instead" (Arjona,
2016, pp. 100-101). It is also consistent with Masullo's claim that
civilian agency "can affect the level of violence that armed groups
...
civilian behavior under reduced military pressure. As Johnson et
al. (2025) conclude, "Total Peace opened a window of opportunity for the
emergence, resurgence, or reconfiguration of rebel or criminal forms of
governance" (p. 21, author's translation). The hypothesis of changing
violent trends therefore does not assume that peace talks automatically
reduce violence; rather, it assumes that they can reconfigure its level,
form, and territorial distribution.
...
reward followers, and survive negotiation cycles. For that reason,
changes in violent trends during peace talks cannot be understood only
as political effects; they must also be read in relation to the economic
resources that sustain armed governance. Taken together, this literature
supports that violence is a direct manifestation of territorial control,
governance, and armed competition, and peace talks may change violent
trends because they alter the timing, incentives, and sequencing of
coercion. In some settings, negotiations may reduce open violence by
freezing conflict or clarifying spheres of control. In others, they may
displace violence geographically or transform it into less visible but
still coercive practices, such as extortion, civilian intimidation, or
selective enforcement. The empirical question of the thesis is therefore
not whether peace talks are inherently pacifying, but whether the onset
of talks under the Total Peace policy is associated with a change in the
level and composition of violence across regions characterized by
different forms of armed governance.

# Research Design

## Research Question

Within Buenaventura, Arauca, and Tumaco where peace negotiations were
initiated under Petro's 'Total Peace' policy (2022-2026), what is the
association between the timing of those negotiations and the monthly
incidence of conflict-related events (homicide, extortion, terrorism,
civilian targeting, and political violence)?

Alternative Hypothesis (H1): The initiation of peace negotiations is
associated with a statistically significant change in the monthly
frequency of specific conflict-related crimes.
...
Alternative Hypothesis 2 (H2): The initiation of peace negotiations is
associated with a statistically significant positive change in frequency
of specific conflict-related crimes.
...
For that reason, the analysis uses an aggregate outcome and a
disaggregated.
...
in which civilians were directly targeted. `political_violence` measures
the monthly count of reported political violence events. In ACLED's
definition, political violence includes battles, violence against
civilians, explosions/remote violence, and the mob violence sub-event
type within riots. The set of variables are used as monthly counts of
observed events rather than fatalities, and both are harmonized to the
same case-month structure. Whereas, the aggregated variable is just the
addition of these five components.
...
The thesis therefore retains OLS as the main specification given its
standard place in difference-in-differences applications and the
directness of its event-count interpretation, but verifies the
substantive findings against Poisson and negative binomial
specifications appropriate for count outcomes.
...
Violence is a mechanism of control. It includes coercive practices aimed
at enforcing rules, punishing disobedience, and shaping local orders.
This logic is consistent with Arjona's argument that "when armed groups
control a territory and pursue long-term goals, they prefer to create
rebelocracies" (Arjona, 2016, pp. 100-101), rebelocracies, are
governments of armed groups whose foundations of govern come from terror
and violent punishment. This is also consistent with Masullo's claim
that civilian agency "can affect the level of violence that armed groups
inflict on civilians (...), the distribution of territorial control and
the establishment of rebel governance" (Masullo, 2020, pp. 2-3). The
selected variables are, therefore, observable expressions of how armed
actors compete, regulate, and govern.

The main explanatory variable is `treatment`, a binary indicator coded
as 1 during the months in which peace talks or formal negotiation
processes were active in a given territorial case, and 0 otherwise. The
treatment is not defined as a final agreement, a ceasefire outcome, or a
successful demobilization, but rather as the period during which
negotiations were underway under the framework of *Política de Paz
Total*, or based on the armed group agreeing to begin the negotiations
...
continued dialogue with successor structures linked to that process (*El
País*, 2025; *La Silla Vacía*, 2025). In Buenaventura, the treatment
begins in September 2022, following the initiation of the preliminary
negotiation phase between Los Shottas and Los Espartanos under the
broader *Paz Total* framework (Johnson et al., 2025, pp. 29--30).
...
For that reason, the effects of peace talks should be analyzed through
territorially grounded case definitions rather than through a uniform
national framework. The central research question is whether the onset
of peace talks under Paz Total is associated with changes in monthly
violent trends in these three cases. The main hypothesis is not that
peace talks uniformly reduce violence. Rather, the argument is that
negotiations may reconfigure violence, altering its level, territorial
distribution, or observable forms depending on the local structure of
armed governance, which affects the dependent variable, hence it is
necessary to include a territorial control.

Additionally, the design includes a time-varying control for armed-group
dispute. The variable Clash is coded as a binary indicator equal to 1 in
months in which a territorial case is experiencing active inter-group
conflict and 0 otherwise. This control is included because changes in
violence may reflect not only negotiation dynamics but also shifts in
territorial confrontation among armed organizations. In substantive
terms, control is especially important for Arauca, where violence rises
in the context of an intensifying dispute beginning in January 2022
(Celis, 2026), and for Buenaventura, where the intensity of
confrontation changes across periods of conflict and truce (SAGA UNODC,
2024; Reynoso, 2025; RTVC, 2025). Tumaco is coded as exposed to
persistent inter-group conflict throughout the observed period.
Including this variable helps distinguish the association between peace
talks and violence from the association between violence and active
armed dispute. More specifically, by adding an interaction term, the
model can test whether the association of treatment differs between
periods with and without clashes.
...
implementation of *Paz Total*, military strategy, or macro-political
shocks, are absorbed by month fixed effects. The inclusion of the
armed-dispute dummy additionally accounts for a substantively important
time-varying source of violence that would otherwise risk confounding
the treatment effect. As a result, the empirical strategy isolates
whether the negotiation period is associated with a deviation from the
prior violent trend within each case, net of both enduring territorial
characteristics and contemporaneous conflict dynamics. Standard errors
are clustered at the territorial-case level, although inference must be
interpreted cautiously given the small number of units. The design
addresses the causal path as displayed in figure 1.
...
National political windows, such as the launch and prioritization of the
*Paz Total* policy, affected all cases and are therefore absorbed by
month fixed effects. Local security crises are included in the design
through the `clash_dummy`, limited to public information availability.
Armed-group willingness to negotiate is more difficult to observe
directly, but to the extent that it reflects durable organizational and
territorial characteristics, much of it is captured by territorial-case
fixed effects. For these reasons, the timing of treatment is unlikely to
be systematically driven by unobserved shocks that operate identically
...
percent confidence intervals and connecting lines that show the
within-case change from the pre-treatment to the treatment period.
...
described in section 4. The discussion centers on the figures rather
than the tables, because the visual presentation makes the comparison
across specifications and outcomes easier to follow. The full regression
tables are available in the appendix. The main specification reports IID
...
talks are systematically associated with lower violence (the substantive
direction implied by the policy's stated goals) is not supported. The
hypothesis that peace talks are associated with higher violence (H2)
receives partial support, with the caveat that the magnitude depends on
whether clashes are simultaneously active.

The reversal between the pooled OLS and the TWFE specifications is
theoretically meaningful. Once case-level baselines are absorbed by the
fixed effects, the within-case association between peace talks and
violence reverses sign, suggesting that the pooled estimates were biased
by selection into treatment. Peace talks tend to occur in
already-peaceful contexts, which biased the naive pooled estimate
downward.
...
violence rather than spread evenly across all forms of violent activity.
The clash coefficient remains positive and statistically significant for
...
framework, which argued that armed actors may reconfigure rather than
abandon coercion during negotiations, and that the form of coercion
depends on the local structure of armed governance.
...
outcomes. H2 receives partial support in the aggregate and stronger
support for political violence specifically.

## Robustness check: alternative count-data specifications

Because the outcome variable is a count of monthly violent events,
...
robustness check reports estimates from three specifications: the main
TWFE OLS model, a Poisson regression with case and month fixed effects,
and a negative binomial regression with case and month fixed effects.
The full table is reported in the appendix as table
...
Across all three specifications, the sign and significance of the key
...
The consistency of point estimates across the OLS, Poisson, and negative
binomial specifications strengthens confidence that the substantive
findings are not artifacts of the distributional assumptions of OLS. The
TWFE-OLS specification is retained for the main analysis given its
standard place in difference-in-differences applications and the
directness of its event-count interpretation. The count-data
...
expression of confrontation, and that negotiations may reconfigure
rather than uniformly reduce coercion. The findings do not support a
simple narrative in which peace talks pacify their territorial settings.
Instead, they suggest that the implementation of Paz Total opened a
window in which the overall observable repertoire of violence
intensified across the three cases, with political violence emerging as
the most identifiable component of that intensification. The remaining
clash dynamics continue to drive a substantial part of monthly
variation, but the negotiation period itself is associated with an
additional positive shift that operates independently of clash activity.

This interpretation is consistent with recent qualitative and
journalistic assessments that have characterized the policy as producing
limited or counterproductive results during its implementation. Johnson
et al. (2025) emphasize that timing and sequencing shape the trajectory
of negotiation processes, and that negotiations conducted under a
\"punishment or reward\" logic, in which armed groups continue
operations during talks, are unlikely to silence the guns. The reports
of FIP (FIP, 2026; Cajiao, 2026) and Ambos and Morales (2026) likewise
document a deterioration of security conditions during the policy's
implementation, with rising counts of disputes and combatants involved.
The quantitative evidence presented here is consistent with that broader
...
associated with an increase across the violent repertoire.
